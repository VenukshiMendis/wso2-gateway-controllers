...
// mirroredNameMismatch is the same rule for the capability name. Not delegable to mcp-validation,
// which is optional: a rewrite would launder the contradiction whenever it is unattached.
