...
const (
	...
	// The operation the MCP resolver sets on every route it serves.
	mcpResolverOperation = "mcp"
)
...
// hasMCPResolver reports whether the MCP resolver has already read this request's body.
...
// such as "draft", also reads as modern. mcp-validation rejects those where it is attached.
